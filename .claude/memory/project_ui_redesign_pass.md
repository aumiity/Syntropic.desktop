...
- **2026-07-14: เพิ่ม Wave 0 — App shell** เพราะ Sidebar/Layout เป็นของที่ทุกหน้าเห็นตลอด เจาะก่อน Wave อื่น — **Sidebar 90% เสร็จ** (pill inset+rounded-lg, hover ตรงกับ active, gap ปุ่มแน่นขึ้น, กรอบนอก `rounded-xl` เจาะจง, width `w-64`, ชิดขอบบน/ซ้าย/ล่างเท่ากันแยกจาก main's `pt-12`); commit `620552c`. เจ้าของประกาศจะทำ **ทั้งระบบทีละหน้า แก้ CSS Component ไปทีละหน้า** ต่อ — เช็ค Wave list ก่อนเจาะหน้าถัดไป
