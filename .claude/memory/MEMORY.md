...
- [Refine schema checklist](project_refine_schema_checklist.md) — **ACTIVE 2026-06-12** — SSOT = `docs/refine_schema.md`; เจอ DEAD COLUMN อย่าลบทันที จดต่อท้าย+ฝัง `DEAD COLUMN`, ลบทีเดียวก่อน launch; ค้าง: `is_for_purchase`, `abbrev_tax_invoice`
