...
**เดือนไม่มีรายการ = โชว์ฟอร์มเปล่าเฉย ๆ** (ผู้ใช้ตัดสิน 2026-06-17): `renderEmptySheet()` แสดงฟอร์มเปล่า (ตารางแถวว่างเต็มหน้า; ledger มีหัวล็อตเปล่า) ในพรีวิว `isEmpty`/`sections.length===0` + hidden `.a4-doc` ตอนพิมพ์ — **ไม่มีเส้นทแยง/ข้อความอัตโนมัติ**. ผู้ใช้พิมพ์ฟอร์มเปล่าแล้วขีดฆ่าเอง (ยืดหยุ่นกว่า). [เคยทำ auto เส้นทแยง+ข้อความ "ไม่มีรายการ..." ตาม อย. แล้ว **ถอดออก** — อย่า re-add เว้นแต่ผู้ใช้ขอ.]
