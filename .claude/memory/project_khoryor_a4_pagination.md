...
- **⚠️ อย่า inline stylesheet ของแอปทั้งก้อน** (เคยลองแล้วพัง 2026-06-17): กฎบางอัน (`@media print`/table) ทำให้ตารางยุบเป็น grid เล็ก ๆ มุมซ้ายบน. ต้อง bake computed style แทน → ทุกเซลล์ได้ความกว้าง px ตายตัว ไม่มีกฎแปลกปลอม → **พิมพ์เหมือนพรีวิวเป๊ะ** (เลี่ยงปัญหา 2 render path / font metric เพี้ยน). print HTML มีแค่ embedded font + กฎ pin `.a4-sheet{width:297mm;height:210mm;break-after:page}` เท่านั้น ไม่มี app CSS.
