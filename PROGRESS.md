...
##   - **Remaining click-test queue (unchanged, items 3+ below):** Dashboard ใหม่ (`/reports/dashboard`), negative-stock + reconciliation, POS cart alerts + bundle expansion, Bundle atomic min-2, ขย.9. See ⚠️ Next session items 0–8.
