...
## 🚧 PAUSED 2026-05-28 (operator went to sleep mid-EditBundle refactor): **Align EditBundle UX to match EditProduct.** Operator asked for tab-by-tab parity. **Tab 1 (General + Price merge) is DONE; Tab 2 (ComponentsTab) is NEXT, untouched.** NOT click-tested. tsc not run yet — verify before resuming.
