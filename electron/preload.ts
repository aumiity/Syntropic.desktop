...
const api = {
  ...
  reports: {
    ...
    vatSummary:         (filters: any) => ipcRenderer.invoke('reports:vatSummary', filters),
  ...
  settings: {
    ...
    upgradeToVat: (data: any) => ipcRenderer.invoke('settings:upgradeToVat', data),
    downgradeFromVat: (data: any) => ipcRenderer.invoke('settings:downgradeFromVat', data),
    hasVatHistory: () => ipcRenderer.invoke('settings:hasVatHistory'),
    ...
    saveLabelLookup: (data: any) => ipcRenderer.invoke('settings:saveLabelLookup', data),
    labelLookupRefs: (data: any) => ipcRenderer.invoke('settings:labelLookupRefs', data),
    reassignLabelLookup: (data: any) => ipcRenderer.invoke('settings:reassignLabelLookup', data),
    deleteLabelLookup: (data: any) => ipcRenderer.invoke('settings:deleteLabelLookup', data),
    listLabelPresets: () => ipcRenderer.invoke('settings:listLabelPresets'),
    saveLabelPreset: (data: any) => ipcRenderer.invoke('settings:saveLabelPreset', data),
    deleteLabelPreset: (id: number) => ipcRenderer.invoke('settings:deleteLabelPreset', id),
