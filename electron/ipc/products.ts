...
export function registerProductHandlers() {
  ...
  ipcMain.handle('products:addUnit', (_e, data: any) => {
    ...
    const result = db.prepare(`
      INSERT INTO product_units (product_id, unit_id, barcode, qty_per_base, price_retail, price_wholesale1, price_wholesale2, is_for_sale, is_disabled)
      VALUES (@product_id, @unit_id, @barcode, @qty_per_base, @price_retail, @price_wholesale1, @price_wholesale2, @is_for_sale, @is_disabled)
    `).run(data)
