...
const PRODUCTS = [
  { name: 'Amoxicillin 500mg',  cat: 'ยาต้านเชื้อ',  price: '12.00', stock: 240, status: 'success' as const },
  { name: 'Paracetamol 500mg',  cat: 'ยาแก้ปวด',     price: '2.50',  stock: 800, status: 'success' as const },
  { name: 'Metformin 500mg',    cat: 'ยาเบาหวาน',    price: '8.00',  stock: 15,  status: 'warning' as const },
  { name: 'Atorvastatin 10mg',  cat: 'ยาลดไขมัน',   price: '35.00', stock: 0,   status: 'danger'  as const },
]
      ...
      <div className="p-8">
            ...
            <div className="mt-3 rounded-md border border-border bg-muted/20 p-3">
              {selectedPaletteColor ? (
                <div className="flex items-center justify-center gap-3 text-xs">
                  ...
                  />
                  <p className="font-semibold text-xstext-foreground">{selectedPaletteColor.family}-{selectedPaletteColor.shade}</p>
        ...
        <Section title="Input" path="src/components/ui/input.tsx">
          ...
          <DemoRow label="States">
            ...
            <Input className="max-w-[180px]" placeholder="Invalid" aria-invalid />
          </DemoRow>
        </Section>
        ...
        <Section title="Textarea" path="src/components/ui/textarea.tsx">
          ...
          <DemoRow label="States">
            ...
            <Textarea className="max-w-[180px]" placeholder="Invalid" aria-invalid />
          </DemoRow>
        </Section>
              ...
              <CardContent>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-emerald-600 font-medium">142 เม็ด</span>
                  </div>
                  <div className="flex justify-between">
            ...
            <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
              ...
              <DialogContent size="md" onClose={() => setDialogOpen(false)}>
                ...
                <DialogFooter>
                  ...
                  <Button onClick={() => { setDialogOpen(false); toast('บันทึกสำเร็จ') }}>
                    บันทึก
                  </Button>
                </DialogFooter>
              </DialogContent>
