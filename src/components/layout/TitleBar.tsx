...
export function TitleBar() {
  ...
  return (
    ...
    >
      {/* App title */}
      <div className="px-4 text-xs font-semibold text-emerald-300 tracking-widest uppercase">
        Syntropic RX
      </div>
      ...
      >
        <button
          onClick={minimize}
          className="w-12 h-full flex items-center justify-center text-emerald-300 hover:bg-emerald-600 hover:text-white transition-colors"
          title="ย่อ"
        >
        ...
        <button
          onClick={close}
          className="w-12 h-full flex items-center justify-center text-emerald-300 hover:bg-red-600 hover:text-white transition-colors"
          title="ปิด"
        >
