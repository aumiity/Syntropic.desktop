  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=segmented]/tabs-list:data-[state=active]:bg-senary group-data-[variant=segmented]/tabs-list:data-[state=active]:text-senary-foreground group-data-[variant=segmented]/tabs-list:data-[state=active]:shadow-sm",
        "dark:group-data-[variant=segmented]/tabs-list:data-[state=active]:bg-senary dark:group-data-[variant=segmented]/tabs-list:data-[state=active]:text-senary-foreground",
